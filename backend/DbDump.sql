...
CREATE VIEW offices_management.history_workspace_statuses AS
 SELECT sw.id_workspace,
   ...
   FROM (((((offices_management.statuses_workspaces sw
     ...
     LEFT JOIN offices_management.posts p ON ((wo.id_worker = p.id_post)))
     LEFT JOIN offices_management.departments d ON ((wo.id_worker = d.id_department)));
...
--
-- TOC entry 4859 (class 2604 OID 16904)
...
--
-- TOC entry 4862 (class 2604 OID 16937)
...
--
-- TOC entry 4863 (class 2604 OID 16964)
...
INSERT INTO offices_management.floors VALUES (10, 1, 6, '', 1, 75);
INSERT INTO offices_management.floors VALUES (11, 2, 6, '', 1, 75);
INSERT INTO offices_management.floors VALUES (12, 1, 10, '', 2, 100);
INSERT INTO offices_management.floors VALUES (13, 2, 15, '', 2, 100);
INSERT INTO offices_management.floors VALUES (1, 1, 15, '', 3, 150);
INSERT INTO offices_management.floors VALUES (6, 2, 15, '', 3, 150);
...
INSERT INTO offices_management.offices VALUES (11, 'Проектный', 'пр. Космонавтов 32', 2, 160, 'office2.jpg', 30);
INSERT INTO offices_management.offices VALUES (12, 'Бугалтерия', 'пр. Моксковский 42', 2, 130, 'offices3.jpg', 25);
...
INSERT INTO offices_management.offices VALUES (2, 'Коворкинг в центре', 'Тверская улица, 15, Москва', 2, 200, 'office2.jpg', 40);
...
INSERT INTO offices_management.offices VALUES (5, 'Коворкинг "Креатив"', 'Улица Садовая, 20, Екатеринбург', 2, 180, 'office2.jpg', 35);
INSERT INTO offices_management.offices VALUES (6, 'Офис "Инновации"', 'Улица Пушкина, 7, Новосибирск', 1, 160, 'office3.jpg', 30);


--
-- TOC entry 5111 (class 0 OID 17040)
-- Dependencies: 251
...
--
-- TOC entry 5107 (class 0 OID 17005)
-- Dependencies: 247
...
--
-- TOC entry 5097 (class 0 OID 16901)
-- Dependencies: 237
...
--
-- TOC entry 5113 (class 0 OID 17097)
-- Dependencies: 253
...
INSERT INTO offices_management.rooms VALUES (4, '201', 3, 2, 25, NULL);
INSERT INTO offices_management.rooms VALUES (5, '202', 3, 2, 25, NULL);
INSERT INTO offices_management.rooms VALUES (6, '203', 3, 2, 25, NULL);
...
INSERT INTO offices_management.rooms VALUES (10, '401', 5, 2, 50, NULL);
INSERT INTO offices_management.rooms VALUES (11, '402', 5, 2, 50, NULL);
INSERT INTO offices_management.rooms VALUES (12, '403', 5, 2, 50, NULL);
...
INSERT INTO offices_management.rooms VALUES (16, '601a', 5, 2, 75, NULL);
INSERT INTO offices_management.rooms VALUES (17, '602', 5, 2, 75, NULL);
INSERT INTO offices_management.rooms VALUES (18, '603', 5, 2, 75, NULL);
...
--
-- TOC entry 5103 (class 0 OID 16934)
-- Dependencies: 243
-- Data for Name: statuses_workers; Type: TABLE DATA; Schema: offices_management; Owner: postgres
--

INSERT INTO offices_management.statuses_workers VALUES (1, '2023-01-01', '2023-01-31', 1, 1, 1, 1);
INSERT INTO offices_management.statuses_workers VALUES (2, '2023-02-01', NULL, 2, 2, 2, 1);
INSERT INTO offices_management.statuses_workers VALUES (3, '2023-03-01', NULL, 3, 3, 3, 1);
INSERT INTO offices_management.statuses_workers VALUES (4, '2023-04-01', NULL, 4, 4, 4, 1);
INSERT INTO offices_management.statuses_workers VALUES (5, '2023-05-01', NULL, 5, 5, 5, 1);
INSERT INTO offices_management.statuses_workers VALUES (6, '2023-06-01', NULL, 6, 6, 6, 1);
INSERT INTO offices_management.statuses_workers VALUES (7, '2023-07-01', NULL, 7, 1, 7, 1);
INSERT INTO offices_management.statuses_workers VALUES (8, '2023-08-01', NULL, 8, 2, 8, 1);
INSERT INTO offices_management.statuses_workers VALUES (9, '2023-09-01', NULL, 1, 3, 9, 1);
INSERT INTO offices_management.statuses_workers VALUES (10, '2023-10-01', NULL, 2, 4, 10, 1);
INSERT INTO offices_management.statuses_workers VALUES (12, '2023-04-21', '2023-08-27', 2, 2, 1, 1);
INSERT INTO offices_management.statuses_workers VALUES (11, '2023-02-01', '2023-04-20', 2, 1, 1, 1);
INSERT INTO offices_management.statuses_workers VALUES (13, '2023-08-28', '2025-06-30', 3, 2, 1, 1);
...
INSERT INTO offices_management.statuses_workspaces VALUES (6, '2023-01-03', NULL, 3, NULL, 3, 1);
INSERT INTO offices_management.statuses_workspaces VALUES (7, '2023-01-04', NULL, 4, NULL, 4, 1);
INSERT INTO offices_management.statuses_workspaces VALUES (8, '2023-01-05', NULL, 5, NULL, 5, 1);
...
INSERT INTO offices_management.users VALUES (1, 'admin', '\x8cdd9346bbdb6f67e399c48eaca610ea030fb6f2131bb43680e077c14a688cc9', 'Пискаев', 'Арсений', 'Романович', false, '5f4c2adf-ec4c-470f-a511-287d1b04fc88');


--
-- TOC entry 5101 (class 0 OID 16927)
-- Dependencies: 241
...
--
-- TOC entry 5099 (class 0 OID 16918)
-- Dependencies: 239
...
SELECT pg_catalog.setval('offices_management.reports_types_id_reports_types_seq', 1, false);
...
--
-- TOC entry 4865 (class 2606 OID 16806)
...
--
-- TOC entry 4873 (class 2606 OID 16831)
...
--
-- TOC entry 4867 (class 2606 OID 17067)
...
--
-- TOC entry 4903 (class 2606 OID 17044)
...
--
-- TOC entry 4905 (class 2606 OID 17046)
...
--
-- TOC entry 4877 (class 2606 OID 16852)
...
--
-- TOC entry 4879 (class 2606 OID 16869)
...
--
-- TOC entry 4895 (class 2606 OID 17009)
...
--
-- TOC entry 4897 (class 2606 OID 17011)
...
--
-- TOC entry 4885 (class 2606 OID 16906)
...
--
-- TOC entry 4899 (class 2606 OID 17026)
...
--
-- TOC entry 4901 (class 2606 OID 17028)
...
--
-- TOC entry 4907 (class 2606 OID 17101)
...
--
-- TOC entry 4909 (class 2606 OID 17103)
...
--
-- TOC entry 4881 (class 2606 OID 16882)
...
--
-- TOC entry 4887 (class 2606 OID 16925)
...
--
-- TOC entry 4891 (class 2606 OID 16939)
...
--
-- TOC entry 4871 (class 2606 OID 16822)
...
--
-- TOC entry 4889 (class 2606 OID 16932)
...
--
-- TOC entry 4883 (class 2606 OID 16894)
...
--
-- TOC entry 4911 (class 2606 OID 17068)
...
--
-- TOC entry 4910 (class 2606 OID 17047)
...
--
-- TOC entry 4912 (class 2606 OID 17073)
...
--
-- TOC entry 4913 (class 2606 OID 16858)
...
--
-- TOC entry 4914 (class 2606 OID 16870)
...
--
-- TOC entry 4915 (class 2606 OID 17012)
...
--
-- TOC entry 4919 (class 2606 OID 16907)
...
--
-- TOC entry 4920 (class 2606 OID 16912)
...
--
-- TOC entry 4921 (class 2606 OID 17029)
...
--
-- TOC entry 4916 (class 2606 OID 16883)
...
--
-- TOC entry 4917 (class 2606 OID 17104)
...
--
-- TOC entry 4922 (class 2606 OID 16945)
...
--
-- TOC entry 4923 (class 2606 OID 16955)
...
--
-- TOC entry 4924 (class 2606 OID 16950)
...
--
-- TOC entry 4925 (class 2606 OID 16940)
...
--
-- TOC entry 4926 (class 2606 OID 16967)
...
--
-- TOC entry 4927 (class 2606 OID 16982)
...
--
-- TOC entry 4928 (class 2606 OID 16972)
...
--
-- TOC entry 4918 (class 2606 OID 16895)
